...
export const SKILLSSHOWCASE_CONFIG: SkillsShowcaseConfig = {
  SKILLS_ENABLED: false, // 改为 false 即可关闭主页技能展示
  SKILLS_DATA: [
    {
      direction: 'left',
      skills: [
...
export const PHOTOS_CONFIG: PhotosConfig = {
  title: 'Photos',
  description: 'Some things are better kept in light than in words.',
  introduce: 'Some things are better kept in light than in words.',
}
